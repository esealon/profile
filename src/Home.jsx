      ...
      <Box onClick={handleClick}>
        <CenteredBox>
          ...
          <Collapse in={open}>
            ...
            <p>
              I was born and raised in Guatemala in a lovely Catholic family, my
              dad has always been quite adventurous, he loves to travel to visit
              the United States all the time and when I was a kid, every time he
              will leave, I wouldn’t like it, but at the same I would think how
              would be to get into a plane and go there.
            </p>
            ...
            <p style={{ height: "10px" }}></p>
            <p>
              I am excited about the future, because I know it holds many challenges
              for me and I have the energy and attitude to take them. If you read
              this far, uff, let me tell you: Thank you very much!
            </p>
          </Collapse>
        </CenteredBox>
      </Box>
